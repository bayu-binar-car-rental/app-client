...
export default function CarCard(car: ICars) {
  return (
    <div className="border border-slate-300 rounded-md bg-white shadow-md relative overflow-hidden">
      {car.available ? (
      ...
      <div className="space-y-3 p-5">
        ...
        <div className="flex space-x-4 pt-4">
          ...
          <button className="w-full p-3 px-4 flex bg-green-500 rounded-sm space-x-2 items-center justify-center hover:bg-green-600">
            <span>
